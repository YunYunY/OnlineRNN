...
from onlinernn.datasets.data_utils import ReshapePermuteTransform, ExtendAddNoise
# -------------------------------------------------------
# Noisy CIFAR
...
class CIFARNoise(BaseDataset):
    def __init__(self, opt):
        ...
        data_transforms.append(ReshapePermuteTransform((32, 32*3)))
